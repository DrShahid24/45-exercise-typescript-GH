...
let guestList = ["Muhammad Shahid", "Humzah Murza", "Rakhmin Gul", "Zain"];
...
guestList.forEach(List => console.log(`Hello, how are you ${List}, would you like to dinner on Sunday.`));
...
while(guestList.length > 2){
    let removeguestList = guestList.pop();
    console.log(`Sorry ${removeguestList}, i can’t invite you to dinner.`)
}

// invitation to remaining guests.
console.log("invitation to the last two guests");
guestList.forEach(lastTwo=> console.log(`Hello, ${guestList}, you are still in my guest list and have a dinner with me.`));
