...
let guestList = ["Muhammad Shahid", "Humza h Murza", "Rakhmin Gul", "Zain"];
...
guestList.forEach(lastTwo=> console.log(`Hello, ${lastTwo}, you are still in my guest list and have a dinner with me.`));
